...
public class ModuleInstaller {
    static final String TAG = ModuleInstaller.class.getSimpleName();

    private static final String DIR = "opt";
     ...
     * @param dexPath
     */
    private static void applyPatch(Context context, String dexPath) {
//        if (IS_VM_CAPABLE) {
//            //art虚拟机走另外一套fix
//            return;
//        }
        ...
        try {
            ...
            synchronized (installedApk) {
                ...
                installDexes(loader, mOptDir, files);
            }
